...
由于无法从 [dolfyn.net](https://www.dolfyn.net)获取代码, 我们使用 [PhoronixTestSuite](https://openbenchmarking.org/test/pts/dolfyn) 的版本
...
完整 benchmark 日志可查看 [dolfyn.log](./dolfyn.log)
